...
@Component({
    selector: 'jhi-accounts-receivable',
...
export class AccountsReceivableComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.accountsReceivableService
                ...
                .subscribe(
                    (res: HttpResponse<AccountsReceivable[]>) => this.onSuccess(res.body, res.headers),
    ...
    trackId(index: number, item: AccountsReceivable) {
        return item.id;
    }
    registerChangeInAccountsReceivables() {
        this.eventSubscriber = this.eventManager.subscribe('accountsReceivableListModification', response => this.loadAll());
    }
