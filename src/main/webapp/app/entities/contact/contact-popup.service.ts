        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.contactService.find(id).subscribe((contactResponse: HttpResponse<Contact>) => {
                    ...
                    contact.createdDate = this.datePipe.transform(contact.createdDate, 'yyyy-MM-ddTHH:mm:ss');
                    contact.lastModifyDate = this.datePipe.transform(contact.lastModifyDate, 'yyyy-MM-ddTHH:mm:ss');
