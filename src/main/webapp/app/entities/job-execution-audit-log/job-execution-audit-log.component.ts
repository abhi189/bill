...
@Component({
    selector: 'jhi-job-execution-audit-log',
    templateUrl: './job-execution-audit-log.component.html'
})
export class JobExecutionAuditLogComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/job-execution-audit-log'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    registerChangeInJobExecutionAuditLogs() {
        this.eventSubscriber = this.eventManager.subscribe('jobExecutionAuditLogListModification', response => this.loadAll());
    }
