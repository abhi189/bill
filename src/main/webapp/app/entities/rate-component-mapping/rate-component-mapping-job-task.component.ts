...
@Component({
    selector: 'jhi-rate-component-mapping-job-task',
...
export class RateComponentMappingJobTaskComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.rateComponentMappingService
            .getRateComponentMappingsByTariffIdAndJobId({
                page: this.page - 1,
