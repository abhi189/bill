...
import { DiscountDialogComponent } from '../../../../../../main/webapp/app/entities/discount/discount-dialog.component';
...
describe('Component Tests', () => {
    describe('Discount Management Dialog Component', () => {
        let comp: DiscountDialogComponent;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DiscountDialogComponent, '')
                .compileComponents();
        }));
        ...
        describe('save', () => {
            it('Should call update service on save for existing entity', inject(
                ...
                fakeAsync(() => {
                    ...
                    expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'discountListModification', content: 'OK' });
