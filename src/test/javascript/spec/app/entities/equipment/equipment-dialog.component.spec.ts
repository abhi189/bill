...
import { EquipmentDialogComponent } from '../../../../../../main/webapp/app/entities/equipment/equipment-dialog.component';
...
describe('Component Tests', () => {
    describe('Equipment Management Dialog Component', () => {
        let comp: EquipmentDialogComponent;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(EquipmentDialogComponent, '')
                .compileComponents();
        }));
